...
// Задание
// Используя события клавиатуры, сформируйте вывод в косноль сообщения "Привет мир!" только в том случае, если будут нажаты клавиши shift + t (не учитывая регистр и раскладку) 
...
// решение с дочерними элементами можно сделать через позициионирование, тогда тоже будет работать. Но получается трохе громоздко
